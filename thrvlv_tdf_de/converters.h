...
template <int N>
SCA_TDF_MODULE(conv_sc_tdf)
{
public:
	sca_tdf::sca_de::sca_in< sc_bv<N> > inDE;
	sca_tdf::sca_out<sc_bv<N> > outTDF;
	...
	SCA_CTOR(conv_sc_tdf) :inDE("inDE"),outTDF("outTDF") {};
};
...
public:
	...
	void set_attributes() {
		set_timestep(sca_core::sca_time(0.01, sc_core::SC_MS));
		//outDE.set_delay(1);
		accept_attribute_changes();
	}
